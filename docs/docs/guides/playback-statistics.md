...
strings in the usual [foobar2000](https://foobar2000.org) `YYYY-MM-DD HH:MM:SS` format,
...
After updating value(s) for a `handle`, you must use `RefreshStats` so the [foobar2000](https://foobar2000.org) core
