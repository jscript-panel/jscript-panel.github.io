...
!!! note
	This was removed in component version `3.4.0`. See [gradients](../guides/gradients.md) for more information.
...
|w|`number`|
|h|`number`|
|str|`string`|See [gradients](../guides/gradients.md).|
