...
- The properties when creating an object to be stringified for [IJSGraphics FillGradientRectangleAdvanced](../interfaces/IJSGraphics.md#fillgradientrectangleadvancedx-y-w-h-str) must now be capitalised.
