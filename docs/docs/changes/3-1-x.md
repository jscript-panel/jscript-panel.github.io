!!! note
	[foobar2000](https://foobar2000.org) `2.0` was a requirement for the `3.1.x` and `3.2.x`
...
- [IMetadbHandle GetFileInfo](../interfaces/IMetadbHandle.md#getfileinfo) has been updated so the previously
...
all `Console` messages using [console.GetLines](../namespaces/console.md#consolegetlineswith_timestamp). Additonally,
