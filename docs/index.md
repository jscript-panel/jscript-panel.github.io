...
* [Save settings](docs/namespaces/window/#windowgetpropertyname-default_value) on a per panel basis. These persist between restarts
...
* [Built in support](docs/namespaces/utils/#utilshttprequestasyncwindow_id-type-url-user_agent_or_headers-post_data-content_type) for
